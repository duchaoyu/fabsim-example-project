// best_fit_stretch_factors_3region_adaptive_cable.cpp
//
...
//
// This variant carries the crease cable of best_fit_stretch_factors_cable.cpp:
// the forward simulation solves CompositeModel<membrane, cable> rather than the
// membrane alone. Everything else — regions, seeds, material, the alternating
// scheme — is identical to best_fit_stretch_factors_3region_adaptive.cpp, so
// the two runs differ only in the presence of the cable.
                                ...
                                bool update_warm)
{
  ...
  fsim::OrthotropicStVKMembrane membrane(V0_mod, F, ths, E1s, E2s, nus, face_dirs, mass, pressure);
  fsim::CompositeModel model(std::move(membrane), buildCable());
