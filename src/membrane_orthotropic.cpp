...
//  V /= 10; // total 5m
  ...
  double young_modulus1 = 10; // 10 MPa
...
//  const double young_modulus = 10000000; // 10 MPa
  ...
  fsim::OrthotropicStVKMembrane model(V , F, thickness, young_modulus1, young_modulus2, poisson_ratio, mass);
  ...
  polyscope::state::userCallback = [&]()
  {
      ...
      if(ImGui::InputDouble("Stretch factor", &stretch_factor, 0, 0, "%.2f"))
        model = fsim::OrthotropicStVKMembrane(V / stretch_factor, F, thickness, young_modulus1, young_modulus2, poisson_ratio, mass);
      ...
      if(ImGui::InputDouble("Modulus", &young_modulus1, 0, 0, "%.2f"))
        model = fsim::OrthotropicStVKMembrane(V / stretch_factor, F, thickness, young_modulus1, young_modulus2, poisson_ratio, mass);

      if(ImGui::InputDouble("Modulus", &young_modulus2, 0, 0, "%.2f"))
        model = fsim::OrthotropicStVKMembrane(V / stretch_factor, F, thickness, young_modulus1, young_modulus2, poisson_ratio, mass);
