...
file_network = os.path.join(folder, "2part.json")
file_session = os.path.join(folder, "mesh_out_2parts_20240802002320.json")
...
mesh_1.to_json(os.path.join(FOLDER, 'mesh_out_2parts_{}.json'.format(formatted_time)))
